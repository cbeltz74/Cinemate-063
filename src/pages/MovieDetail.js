...
export const MovieDetail = ({title}) => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=b962ccd28bc15575e4959ab603d9f48d`);
      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          <p className="my-4">{movie.overview}</p>
            ...
            <p>
              <span className="my-4 font-bold">Runtime: </span>
              <span>{movie.runtime} min.</span>
            </p>

            <p>
              <span className="my-4 font-bold">Budget: </span>
            ...
            <p>
              <span className="my-4 font-bold">Release Date: </span>
              <span>{movie.release_date}</span>
            </p>

            <p>
              <span className="my-4 font-bold">IMDB Code: </span>
